/*
  ...
  gengetopt --header-output-dir=include --src-output-dir=src --c-extension=cpp
...
const char *gengetopt_args_info_usage = "Usage: automate [OPTIONS]...";

const char *gengetopt_args_info_versiontext = "None";
...
const char *cmdline_parser_action_values[] = {"display", "sgbm", "calibrate", "dist", "poi", 0}; /*< Possible values for action. */
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->action_arg = action_arg_display;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->prefix_help = gengetopt_args_info_detailed_help[5] ;
  args_info->action_help = gengetopt_args_info_detailed_help[6] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:o:p:a:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'i':	/* Le dossier contenant les images à traiter.  */
          ...
          break;
        case 'o':	/* Le dossier qui contiendra les images traitées.  */
          ...
          break;
        case 'p':	/* Prefix à appliquer aux noms de fichiers à sauvegarder.  */
        ...
        case 'a':	/* L'action a effectuer sur chaque fichier.  */
          ...
          if (update_arg( (void *)&(args_info->action_arg), 
              ...
              &(local_args_info.action_given), optarg, cmdline_parser_action_values, "display", ARG_ENUM,
              check_ambiguity, override, 0, 0,
              "action", 'a',
              additional_error))
            goto failure;
